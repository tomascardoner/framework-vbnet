...
Public Class CS_Control_TextBox_Number
    ' How to use:
    ' Using as a control:
    ...
    Private mNumberStyle As Globalization.NumberStyles

    Public Property NumberStyle As Globalization.NumberStyles
        Get
            Return mNumberStyle
        End Get
        Set(value As Globalization.NumberStyles)
            mNumberStyle = value
        End Set
    End Property
    ...
    Public Overrides Property Text As String
        ...
        Set(ByVal value As String)
            Try
                MyBase.Text = FormatNumber(Decimal.Parse(value, mNumberStyle, mNumberFormat).ToString, IIf(mNumberStyle And Globalization.NumberStyles.AllowDecimalPoint, -1, 0))
    ...
    Public ReadOnly Property Value As Decimal?
        Get
            If MyBase.Text.Length = 0 Then
                Return Nothing
            Else
                Return Decimal.Parse(MyBase.Text, mNumberStyle, mNumberFormat)
            End If
        End Get
    End Property
    ...
    Private Sub Me_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
        If Not MyBase.ReadOnly Then
            If MyBase.Text.Length = 0 Then
                MyBase.Text = ""
            Else
                MyBase.Text = Decimal.Parse(MyBase.Text, mNumberStyle, mNumberFormat).ToString
            End If
        End If
    End Sub
    ...
    Private Sub Me_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        ...
        If e.KeyChar = Chr(Keys.Back) Then
            ...
            Else
                ...
                Exit Sub
            End If
            'If MyBase.Text.Chars(MyBase.Text.Length - 1) = mNumberFormat.NumberDecimalSeparator.Chars(0) Then
            '    mDecimalPeriod = False
            'End If
            'Exit Sub
        ElseIf Char.IsDigit(e.KeyChar) = False Then
            ...
            If mDecimalPeriodPressed Then
                ...
                e.KeyChar = mNumberFormat.NumberDecimalSeparator.Chars(0)
                mDecimalPeriodPressed = False
            End If

            If e.KeyChar = mNumberFormat.NumberDecimalSeparator.Chars(0) Then
    ...
    Private Sub Me_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.LostFocus
        If Not MyBase.ReadOnly Then
            If MyBase.Text.Length = 0 Then
                MyBase.Text = ""
            Else
                MyBase.Text = FormatNumber(Decimal.Parse(MyBase.Text, mNumberStyle, mNumberFormat).ToString, IIf(mNumberStyle And Globalization.NumberStyles.AllowDecimalPoint, -1, 0))
            End If
            mDecimalPeriod = False
        End If
    End Sub
    ...
    Private Function IsNumber(ByVal str As String) As Boolean
        ...
        For iCounter = 0 To str.Length - 1
            If Char.IsDigit(str.Chars(iCounter)) = False Then
                If str.Chars(iCounter) = mNumberFormat.NumberDecimalSeparator.Chars(0) And bValidator = False Then
                    bValidator = True
                Else
                    Return False
                    Exit Function
