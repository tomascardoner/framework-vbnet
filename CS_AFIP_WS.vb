...
#Region "Declarations"
    Friend Const SERVICIO_FACTURACION_ELECTRONICA As String = "wsfe"

    Friend Const SOLICITUD_CAE_RESULTADO_ACEPTADO As String = "A"
    Friend Const SOLICITUD_CAE_RESULTADO_RECHAZADO As String = "R"
    Friend Const SOLICITUD_CAE_RESULTADO_PARCIAL As String = "P"
...
#Region "Clase Principal"
    Friend Class AFIP_WS
        ...
        Friend Function FacturaElectronica_Login() As Boolean
            Return Login(SERVICIO_FACTURACION_ELECTRONICA)
        End Function
        ...
        Friend Function FacturaElectronica_ObtenerCAE(ByRef FacturaAGenerar As FacturaElectronicaCabecera) As Boolean
            ...
            Try
                ...
                If WSFEv1.Resultado = SOLICITUD_CAE_RESULTADO_ACEPTADO Then
