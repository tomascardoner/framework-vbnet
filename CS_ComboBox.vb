Module CS_ComboBox
    ...
    Friend Sub SetSelectedValue(ByRef ComboBoxControl As ComboBox, Optional SelectedItemOption As SelectedItemOptions = SelectedItemOptions.None, Optional ValueToSelect As Object = Nothing, Optional ValueForNull As Object = Nothing)
